...
class List2UnitTest(unittest.TestCase):
    ...
    # Remove Adjacent Duplicate Entries
    ...
    #
    # Merge Sorted Lists to Sorted Combined List
    #
    ...
    def do_test_merge(self, expected, list_1, list_2):
        """ Test both implementations of list merge """

        # Code assumes input lists are already sorted
        ...
        # Copy lists because merge_lists modifies its input lists
        list_1a = list_1[:]
        list_2a = list_2[:]
